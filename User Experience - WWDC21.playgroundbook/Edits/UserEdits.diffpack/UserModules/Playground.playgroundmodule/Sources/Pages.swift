...
public struct Pages {
    ...
    public static let bank = [
        Page(
            ...
            problemDescription: "We are dealing with a simple 'Create Profile' screen as an exmaple and discover what makes a good UX. The preview on the left is going to be fully interactive. \n\nTap the 'Run app' button and try to create your profile there - you will notice many usability issues, especially in the case of unexpected input. We will improve the UX step by step with some explanation and key lessons to take away.",
        ...
        Page(
            ...
            improvmentDescription: "As of right now, the example app will only tell the user if the input is corret when the 'Create' button was tapped and provides just general help. He can't know which input was incorrect.\n\n▶︎ Performing the input validation in realtime and indicating the result instantly\n▶︎ Providing helpful error messages and tips\n▶︎ Usage of colors to indicate errors (red) and correct input (green)"),
        Page(
