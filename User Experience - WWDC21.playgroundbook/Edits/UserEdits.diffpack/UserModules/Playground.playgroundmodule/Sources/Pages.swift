...
public struct Pages {
    ...
    public static let bank = [
        ...
        Page(
            ...
            improvmentDescription: "As of right now, the example app will only tell the user if the input is correct when the 'Create' button was tapped and provides just general help. He can't know which input was incorrect.\n\n▶︎ Performing the input validation in realtime and indicating the result instantly\n▶︎ Providing helpful error messages and tips\n▶︎ Usage of colors to indicate errors (red) and correct input (green)"),
        Page(
        ...
        Page(headline: "Congratulations  🚀",
                ...
                problemDescription: "The three usability \"rules\" can be applied when designing a new experience, such as an app. Always remember, there are no dumb users - there is only bad design. If you like, tap 'Run final app' and play around with the current app further. You can think about other bits that could be improved.\n\nI wish you a great WWDC21, see you there!",
