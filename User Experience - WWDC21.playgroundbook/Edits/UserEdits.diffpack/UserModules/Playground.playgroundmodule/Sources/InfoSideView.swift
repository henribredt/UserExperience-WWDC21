...
public struct InfoSideView: View {
    ...
    public var body: some View {
        VStack(alignment: .leading, spacing: 5){
            ...
            // contents including all explanation texts
            pageContent 
            ...
            // footer including navigation button and progress indicator
            footer 
    ...
    // pageContent: all texts including titles, explanations and improvemnt suggestions
    ...
    // footer: navigation button and progress indicator
